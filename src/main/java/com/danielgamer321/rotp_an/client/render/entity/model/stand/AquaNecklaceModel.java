package com.danielgamer321.rotp_an.client.render.entity.model.stand;
...
public class AquaNecklaceModel extends HumanoidStandModel<AquaNecklaceEntity> {
	...
	@Override
	protected ModelPose<AquaNecklaceEntity> initIdlePose() {
		return new ModelPose<>(new RotationAngle[] {
				...
				RotationAngle.fromDegrees(leftLowerLeg, 16.8641F, 4.3729F, 5.2995F),
	...
	@Override
	protected ModelPose<AquaNecklaceEntity> initIdlePose2Loop() {
		return new ModelPose<>(new RotationAngle[] {
